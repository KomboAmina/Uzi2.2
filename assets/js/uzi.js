...
function handleLengthValue(){
    ...
    if(rawLength>maxlength){rawLength=maxlength;}
...
function generateQRCode(givenString){
    ...
    if(givenString.length<=1270){

        document.getElementById('qrlabel').innerHTML=givenString;
        ...
        document.getElementById('qrlabel').innerHTML="qr code can only generated with less than 1271 characters.";
